...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    {
      name: 'Accountability Scorecards',
      path: '/accountability-scorecards',
    ...
    },
    {
      ...
      path: '/regular-meetings',
      entity: 'regular_meetings',
      service: AccessServiceEnum.PROJECT,
      icon: FiCalendar,
    },
    {
      name: 'User Performances',
    ...
    {
      name: 'Vision Strategies',
      path: '/vision-strategies',
