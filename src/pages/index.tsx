...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Entrepreneur operating system`}</title>

        <meta
          name="description"
          content="Entrepreneur Operating System: Empowering your business with robust tools to enhance Vision, People, Data, Issues, Process, and Traction. Implement practical steps, hold regular meetings, and utilize scorecards for unwavering accountability and continuous improvement."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1665686310934-8fab52b3821b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxidXNpbmVzc3xlbnwwfHx8fDE2OTY5NTI0MjB8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Entrepreneur Operating System: Empowering your business with robust tools to enhance Vision, People, Data, Issues, Process, and Traction. Implement practical steps, hold regular meetings, and utilize scorecards for unwavering accountability and continuous improvement.`}
            </Text>
            <Box
